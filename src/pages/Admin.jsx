...
const ChallengeManager = lazy(() => import('../components/admin/ChallengeManager').then(module => ({ default: module.ChallengeManager })))
const StudentProgress = lazy(() => import('../components/admin/StudentProgress').then(module => ({ default: module.StudentProgress })))
